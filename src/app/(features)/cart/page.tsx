  ...
  return (
    <div id="__layout">
      ...
      >
        ...
        <div
          id="indexSuperCart"
          data-fetch-key="IndexSuperCart:0"
          className="super-cart-container"
          data-v-1546f1ba=""
        >
          <div className="cart-header" data-v-9572cbae="">
            <div className="go-back" data-v-9572cbae="">
              <Link
              ...
              <p className="title" data-v-9572cbae="">
                Giỏ hàng của bạn
              </p>{" "}
              <div data-v-9572cbae=""></div>
            </div>
          </div>{" "}
          <div className="tabs-cart-type container mt-3">
            <button data-type="1" className="tab-item active">
              Giỏ hàng
            </button>
            <button data-type="2" className="tab-item">
              Trả góp
            </button>
          </div>{" "}
          <div className="block-info container mt-3">
            <div id="listItemSuperCart">
              ...
              <div className="block__product-item__outer">
                <div className="block__product-item">
                  <div className="checkbox-product">
                    <div className="select-product-action custom-control custom-checkbox">
                      ...
                      >
                        <Image
                          src="https://cdn2.cellphones.com.vn/insecure/rs:fill:350:0/q:80/plain/https://cellphones.com.vn/media/catalog/product/r/o/robot-hut-bui-ecovacs-deebot-t50-pro-gen-2-1_1.jpg"
                          width={350}
                          height={350}
                  ...
                  <div className="product-info">
                    <div className="d-flex justify-content-between align-items-start">
                      <div className="product-name">
                        <Link href="https://cellphones.com.vn/robot-hut-bui-ecovacs-deebot-t50-pro-gen-2.html">
                          Robot hút bụi lau nhà Ecovacs Deebot T50 PRro Gen
                          2-Đen
                        </Link>
                      </div>{" "}
                      ...
                      <div>
                        <div className="block-box-price">
                          ...
                          <div className="box-info__box-price">
                            <p className="product__price--show">15.490.000đ</p>{" "}
                ...
                <div
                  data-v-4d26b11a=""
                  className="km-promotion"
                  style={{ marginBottom: "10px", marginLeft: "25px" }}
                >
                  <div data-v-4d26b11a="" className="title">
                    <Image
                      width={18}
                      height={18}
                      data-v-4d26b11a=""
                      src="https://static-cart.cellphones.com.vn/cart/_nuxt/img/gift.0c5e31b.svg"
                      alt="member"
                    />{" "}
                    <span data-v-4d26b11a="" className="name">
                      Chọn khuyến mãi
                    </span>
                  </div>{" "}
                  <div data-v-4d26b11a="" className="main">
                    <div data-v-4d26b11a="" className="item">
                      <div
                        data-v-4d26b11a=""
                        className="item__index item__index--active"
                      ></div>{" "}
                      <div data-v-4d26b11a="" className="item__name">
                        <div data-v-4d26b11a="">
                ...
                <div className="box_promo"></div>{" "}
                <div>
                  <div
                    data-v-2f74e4d1=""
                    className="combov2-items-cart"
                    style={{ display: "none" }}
                  >
                    <div
                      data-v-2f74e4d1=""
                      className="combov2-items-cart__wrapper"
                    >
                      <div data-v-2f74e4d1="" className="head">
                        Bạn đang mua kèm <span data-v-2f74e4d1="">0</span> sản
                        phẩm:
                      </div>{" "}
                      <div data-v-2f74e4d1="" className="body"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div>
            <div id="stickyBottomBar">
              <div className="temp-info d-flex flex-column">
                <div className="price-temp">
                  <p>
                    Tạm tính: <span>0đ</span>
                  </p>
                </div>
              </div>{" "}
              <button className="btn-action disabled">Mua ngay</button>
            </div>{" "}
            <div id="viewProductStudent" style={{ display: "none" }}></div>{" "}
            <div id="listConfirmedBMSMModal" style={{ display: "none" }}></div>{" "}
            <div className="clear"></div>
          </div>{" "}
          <div></div>
        </div>{" "}
